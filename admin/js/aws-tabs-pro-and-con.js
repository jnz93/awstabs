    ...
    tinymce.PluginManager.add( 'proAndConBtn', function( editor, url ) {
        ...
        editor.addCommand('proAndConBtn', function() {
            ...
            var titleList = '<h3>Adicione um título para lista</h3>',
                titlePro = '<h3 style="display: block; margin: 12px auto; padding-left: 16px; background-color:#479c47; color: #f2f2f2;">Prós</h3>',
                titleCon = '<h3 style="display: block; margin: 12px auto; padding-left: 16px; background-color:#e04343; color: #f2f2f2;">Contras</h3>';
